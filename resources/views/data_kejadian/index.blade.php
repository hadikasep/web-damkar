...
@section('main')
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Data Kejadian</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="/tambah" class="btn-sm btn-primary text-decoration-none">Tambah data</a>
                                ...
                                <tr>
                                    ...
                                    <td><a href="/edit/{{ $item->id }}"
                                        ...
                                        <form onsubmit="return confirmHapus(event)"
                                            action="/hapus/{{ $item->id }}" method="post" class="d-inline">
                                            @csrf
